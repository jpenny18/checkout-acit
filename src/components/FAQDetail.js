  ...
  const answers = {
    ...
    'how to start?': {
      content: [
        ...
        '2. Choose your preferred account size ($50,000, $100,000, or $200,000)',
        '3. Complete the payment for your chosen challenge',
    ...
    'what is acit?': {
      content: [
        ...
        '• Offers account sizes from $50,000 to $200,000',
    ...
    'what will be the size of my acit account?': {
      content: [
        ...
        '• Standard Accounts: $50,000, $100,000, or $200,000',
